...
This plot shows sample origin and quantity, and sex proportion
...
This will show a map of where samples were caught
```{r sample_map, include=TRUE, ECHO=FALSE, WARNING=FALSE}
setwd("~/Desktop/MasterR")
